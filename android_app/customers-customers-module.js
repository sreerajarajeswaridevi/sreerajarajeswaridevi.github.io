...
/* harmony import */ var _store_customers_selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../store/customers.selectors */ "./src/app/customers/store/customers.selectors.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_components_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/components/confirm-modal/confirm-modal.component */ "./src/app/shared/components/confirm-modal/confirm-modal.component.ts");
/* harmony import */ var _shared_components_customers_modal_customers_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../shared/components/customers-modal/customers-modal.component */ "./src/app/shared/components/customers-modal/customers-modal.component.ts");
...
var CustomersComponent = /** @class */ (function () {
    function CustomersComponent(modalService, store) {
    ...
    CustomersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isLoading$ = this.store.select(_store_customers_selectors__WEBPACK_IMPORTED_MODULE_5__["getIsLoading"]);
        this.customersSub = this.store.select(_store_customers_selectors__WEBPACK_IMPORTED_MODULE_5__["getCustomers"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (customers) {
    ...
    CustomersComponent.prototype.onAddCustomer = function () {
        var _this = this;
        this.modalRef = this.modalService.show(_shared_components_customers_modal_customers_modal_component__WEBPACK_IMPORTED_MODULE_8__["CustomersModalComponent"], this.modalConfig);
        this.modalRef.content.heading = 'Add new customer';
        this.modalRef.content.customer.id = this.lastCustomerIndex + 1;
        this.modalRef.content.customerData.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (customerData) {
    ...
    CustomersComponent.prototype.openConfirmModal = function (customer) {
        var _this = this;
        this.modalRef = this.modalService.show(_shared_components_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmModalComponent"], this.modalConfig);
        this.modalRef.content.confirmation.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (confirmation) {
            if (confirmation) {
    ...
    CustomersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_1__["MDBModalService"], _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]])
    ], CustomersComponent);
